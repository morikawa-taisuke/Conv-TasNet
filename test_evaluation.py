...
for angle in angle_list:
    dir_name = f'subset_DEMAND_hoth_1010dB_05sec_{ch}ch_{distance}cm'
    ...
    wave_path = f"{const.MIX_DATA_DIR}\\{dir_name}\\{angle}\\test\\"
    ...
    for wave_type in wave_type_list:
        ...
        print('evaluation')
        eval.main(target_dir=f"{const.MIX_DATA_DIR}\\{dir_name}\\{angle}\\test\\clean",
