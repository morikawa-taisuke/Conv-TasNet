...
if __name__ == "__main__":
    ...
    main(target_dir=f"{const.SAMPLE_DATA}/speech/subset_DEMAND/test/",
         estimation_dir=f"{const.OUTPUT_WAV_DIR}/URelNet/subset_DEMAND_1ch/noise_only",
         out_path=f"{const.EVALUATION_DIR}/URelNet/subset_DEMAND_1ch/noise_only.csv",
         condition=condition,
         channel=1)
