    ...
    for wave_type in wave_type_list:
        for model_type in model_list:
            ...
            main(dataset_path=os.path.join(dataset_dir, wave_type),
                 out_path=os.path.join(pth_dir, f"subset_DEMAND_hoth_1010dB_05sec_4ch_10cm_{wave_type}_{model_type}"),
                 train_count=200,
    ...
    for wave_type in wave_type_list:
        for model_type in model_list:
            ...
            test.test(mix_dir=os.path.join(mix_dir, wave_type),
                      ...
                      model_name=os.path.join(pth_dir, f"subset_DEMAND_hoth_1010dB_05sec_4ch_10cm_{wave_type}_{model_type}", f"BEST_subset_DEMAND_hoth_1010dB_05sec_4ch_10cm_{wave_type}_{model_type}.pth"),
                      channel=channel,
                      model_type=model_type)
